        ...
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    {/* <img src="./assets/images/hotel-night-view.jpg" alt="Dhage Hotel" className="header-image" /> */}
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="phegon-color">Dhage Hotel</span>
                        </h1><br />
            ...
            <h2 className="home-services">Services at <span className="phegon-color">Dhage Hotel</span></h2>

            {/* SERVICES SECTION */}
            <section className="service-section"><div className="service-card">
                <img src="./assets/images/ac-rooms.jpg" alt="Air Conditioning" />
